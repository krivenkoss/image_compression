"""Generate visual image examples for study_02 (compare with original).
...
Usage::
    ...
    python -m studies.study_02_image_examples
"""
...
OUTPUT_DIR = Path("output/study_02_compare_with_original/image_examples")
...
def main() -> None:
    ...
    for name in IMAGES:
        ...
        # Compressed (noisy image fed to coder — same as in the main study)
